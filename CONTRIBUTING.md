...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork:
    ...
    ```
    # Clone your fork
    git clone https://github.com/<your-username>/re-promise.git
...
3.  `npm run build` to build the UMD and ES bundle of the app
...
>
> ```
> git remote add upstream https://github.com/vivek12345/re-promise.git
> git fetch upstream
